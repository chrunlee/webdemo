...
div.style = 'position:fixed;width:100%;height:100%;z-index:-1;opacity:0.5;left:0px;top:0px;'
div.appendChild(ele);
...
//     var _global;
    ...
    function Star(id, x, y, useCache) {
        ...
        this.color = "rgba("+config.rgbColor + alpha + ")";
        if (useCache) {
            this.cache()
        }
    }
    ...
    Star.prototype = {
        ...
        cache : function () {
            ...
            this.cacheCtx.shadowColor = config.color;
    ...
    function Dot(id, x, y, useCache) {
        ...
        this.dotCtx.a = 0.5;
        this.color = "rgba("+config.rgbColor + this.a +")";
        this.dotCtx.color = "rgba("+config.rgbColor + this.dotCtx.a + ")";
        this.linkColor = "rgba("+config.rgbColor + this.a/4 + ")";
    ...
    Dot.prototype = {
        ...
        cache : function () {
            ...
            this.dotCtx.shadowColor = config.color;
