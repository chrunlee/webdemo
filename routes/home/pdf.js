...
router.get('/',async function(req,res,next){
	...
	let cId = req.query.c;
	//根据第一个类别来处理
	let categoryList = await query.query({
	...
	let optionList = await query.query({
